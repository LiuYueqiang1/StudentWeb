...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"7","icon":"","menuname":"学生课程管理",
							"menus":[
									{"menuid":"71","menuname":"课程列表","icon":"icon-book-open","url":"SelectedCourseServlet?method=toSelectedCourseListView"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">学生信息及网课管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; By 【LYQ】</div>
    </div>
