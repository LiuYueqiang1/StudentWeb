	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var temp = $("#add_temp").textbox("getText");
							var password = $("#add_password").textbox("getText");
							var data = {clazzid:clazzid, name:name,sex:sex,mobile:phone,temp:temp,password:password};
	  ...
	  //下拉框通用属性
	  	...
	  	$("#editDialog").dialog({
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var temp = $("#edit_temp").textbox("getText");
							var data = {id:id, clazzid:clazzid, name:name,sex:sex,mobile:phone,temp:temp};
			...
			onBeforeOpen: function(){
				...
				$("#edit_temp").textbox('setValue', selectRow.temp);
	...
	<div id="addDialog" style="padding: 10px;">  
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		...
	    		<tr>
	    			<td>温度:</td>
	    			<td colspan="4"><input id="add_temp" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="temp"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table id="editTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		...
	    		<tr>
	    			<td>温度:</td>
	    			<td colspan="4"><input id="edit_temp" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="temp"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
