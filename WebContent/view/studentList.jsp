	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>温度:</td>
	    			<td><input id="add_temp" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="temp"  /></td>
	    		</tr>
	    		<tr>
	    			<td>班级:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>温度:</td>
	    			<td><input id="edit_temp" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="temp"  /></td>
	    		</tr>
	    		<tr>
	    			<td>班级:</td>
